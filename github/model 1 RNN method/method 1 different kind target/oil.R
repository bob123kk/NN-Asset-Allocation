...
########################################################
# 1 - Get data ### we select data from 2006-08-14 to 2019-07-10, 
#setting trainig data set from 2006-08-16  to 2013-01-21 (which is the 337th data point),
#setting testing data set from "2017-08-14"(which is the 575th data point) to 2019-07-10,
########################################################
date_1 <- which(daily_level_data$date == '2006-08-14')
date_2 <- which(daily_level_data$date == '2013-01-21')
...
startDate <-  as.Date("2006-08-14") 
endDate <- as.Date("2019-07-10")
tickers <- c("OIL")
oil_stock_prices <- tq_get("OIL")

weekly_level_data<- tq_get("OIL", get = "stock.prices", from = startDate, to = endDate, complete_cases = FALSE,periodicity='weekly')
weekly_level_data<-na.omit(weekly_level_data)
daily_level_data<- tq_get("OIL", get = "stock.prices", from = startDate, to = endDate, complete_cases = FALSE)
...
daily_date_features_valid_data_test<- tq_get("OIL", get = "stock.prices", from = test_startDate, to = test_endDate, complete_cases = FALSE)
...
weekly_date_features_valid_data_test<- tq_get("OIL", get = "stock.prices", from = test_startDate, to = test_endDate, complete_cases = FALSE,periodicity='weekly')
...
asset_rtn <- level_data[, c("OIL", "IEF")]
