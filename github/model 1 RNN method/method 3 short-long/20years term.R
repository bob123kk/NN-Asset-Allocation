...
weekly_level_data<- tq_get("HSBA.L", get = "stock.prices", from = startDate1, to = endDate, complete_cases = FALSE,periodicity='weekly')
weekly_level_data<-na.omit(weekly_level_data)
daily_level_data<- tq_get("HSBA.L", get = "stock.prices", from = startDate1, to = endDate, complete_cases = FALSE)
